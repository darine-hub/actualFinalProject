...
import {getreservationsbyId,clickdate} from "../redux/reservationSlice";
...
<div><button onClick={()=> history.push("/salles")}>Add reservation</button>
     <button>Add event</button></div>
